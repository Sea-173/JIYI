  ...
  <div id="main-view">
  	<div class="container">
  		<div class="top-bar">
  			...
  			<ul class="topic-nav">
  				<li><a href="#search-area">商品主页</a></li>
  				<li><a href="#fresh-seckill">百团大战</a></li>
  				<li><a href="#good-fresh">优选活动</a></li>
  			</ul>
  		</div>
  		<side-bar/>
...
import SlideMainView from '@/components/MainPage/SlideMainView'
import SlideSeckill from '@/components/MainPage/SlideSeckill'
import ClubActivities from '@/components/MainPage/ClubActivities'
import GoodService from '@/components/Goods/GoodService'
