<template>
  <div class="product-details">
    ...
    <div class="category-wrapper">
      <div class="category">闲置 > {{ productInfo.name }} > 商品详情</div>
    </div>
    <!-- 主要信息 -->
    <div class="main-area">
      <!-- 产品图片 -->
      ...
      <div class="product-info">
        ...
        <div class="main-details">
          ...
          <div>
            卖家累计评价 <span class="comment-num">{{ productInfo.commentNum }}</span>
          </div>
          <div>
            优惠券
          ...
          <div>
            收货点 <span class="delivery-address">G楼 一楼大厅 <span class="down-arrow"></span></span>
			...
			<ul>
				<router-link
					...
					<div class="recom-product-sale-num">
						<span class="rank">{{ index + 1 }}</span>已卖出{{ getProductInfo(id).saleNum }}件类似商品
					</div>
					<div class="recom-product-price">￥{{ getProductInfo(id).price1 }}</div>
...
export default {
  ...
  data () {
    return {
    	...
    	productNum: 1,
    	discounts: ['满50减1', '满99减5', '满199减10', '满299减30']
    }
  },
  methods: {
