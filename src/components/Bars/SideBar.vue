...
<style scoped>
	...
	.side-bar ul li .category-icon {
		...
		width: 30px;
		height: 30px;
		background:  url('../../assets/img/main-view/icons/book.png') no-repeat 0 0;
	...
	.side-bar ul li:nth-child(2) .category-icon {
		background-image: url(../../assets/img/main-view/icons/seafood.png);
	}
	.side-bar ul li:nth-child(3) .category-icon {
		background-image: url(../../assets/img/main-view/icons/stationery.png);
	}
	.side-bar ul li:nth-child(4) .category-icon {
		background-image: url(../../assets/img/main-view/icons/desktop.png);
	}
	.side-bar ul li:nth-child(5) .category-icon {
		background-image: url(../../assets/img/main-view/icons/phone.png);
	}
	.side-bar ul li:nth-child(1):hover .category-icon {
		background-image: url(../../assets/img/main-view/icons/book-active.png);
	}
	.side-bar ul li:nth-child(2):hover .category-icon {
		background-image: url(../../assets/img/main-view/icons/seafood-active.png);
	}
	.side-bar ul li:nth-child(3):hover .category-icon {
		background-image: url(../../assets/img/main-view/icons/stationery-active.png);
	}
	.side-bar ul li:nth-child(4):hover .category-icon {
		background-image: url(../../assets/img/main-view/icons/desktop-active.png);
	}
	.side-bar ul li:nth-child(5):hover .category-icon {
		background-image: url(../../assets/img/main-view/icons/phone-active.png);
	}
