<template>
  <div class="product-list">
  	<div class="list-title" v-if="item!='关注的社团'">
    ...
    <div v-if="item!='关注的社团'">
  	<ul class="list-content">
  		<li v-for="product in showingProductList">
			...
			<p class="comments"><span>{{ product.commentNum }}人留言</span></p>
			<p class="favorable-rate">卖家{{ product.favorableRate }}%好评</p>
    ...
    <div v-if="item =='关注的社团'">
      <ul class="list-content">
        <li v-for="product in showingProductList">
          ...
          <div class="club-activity" style="text-align: center">{{product.clubActivity}}</div>
          <img class="club-img" :src="getClubImgPath(product.imageName)">
          <span class="lowering-price" v-show="calLoweringPrice(product) > 0">
				    <span class="lowering-price-icon"></span>
				    <span class="lowering-price-text"></span>
			    </span>
          <div class="club-name"><span>社团：{{ product.name }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div>
          <div class="ac-date"><span>时间：{{product.activityDate}}&nbsp;&nbsp;</span></div>
          <div class="ac-place"><span>地点：{{product.activityLocation}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div>
          <div :class="getApplyClass(product.isApplyed)"><span >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{product.isApplyed}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div>
        </li>
      </ul>
    </div>
  </div>
  ...
  methods: {
    ...
    ,
  	getProductImgPath: function (name) {
  		return require('../../assets/img/user-center/my-focus/' + name);
  	},
