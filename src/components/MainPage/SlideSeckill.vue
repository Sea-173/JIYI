<template>
  <slide-base
    ...
    <ul v-bind:style="{left: offset + 'px'}" class="slide-ul">
      <li>
        <ul class="slide-unit">
          <router-link v-for="club in getSlideClub.slice(10, 15)"
      ...
      <li>
        <ul class="slide-unit">
          <router-link v-for="club in getSlideClub.slice(0, 5)"
                       :to="{name: 'ClubDetails', params: {id: club.id}}"
                       tag="li">
            <div class="seckill-price">
              <span class="price1">{{ club.name }}</span>
  ...
  computed: {
    ...
    slideContentArr: function () {
      return [
        {
          index: 0,
          clubs: this.getSlideClub.slice(0, 5),
        },
        {
          index: 1,
          clubs: this.getSlideClub.slice(5, 10),
        },
        {
          index: 2,
          clubs: this.getSlideClub.slice(10, 15),
        },
      ]
    },
  },
